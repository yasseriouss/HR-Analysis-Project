...
|---|---|---|---|---|
| Auto_Logo0 | Image |  |  |  |
| Auto_Header0 | Label |  | استعلام1 |  |
| Auto_Date | TextBox | =Date() |  |  |
| Auto_Time | TextBox | =Time() |  |  |
| تسمية0 | Label |  | اسم المستخدم |  |
| تسمية1 | Label |  | اجمالى عدد الساعات |  |
| اسم المستخدم | TextBox | اسم المستخدم |  |  |
| Sumمنحقل1 | TextBox | Sumمنحقل1 |  |  |
| نص18 | TextBox | =\"صفحة \" & [Page] & \" من \" & [Pages] |  |  |
| AccessTotalsاسم المستخدم | TextBox | =Count(*) |  |  |
        ...
        Begin FormFooter
            ...
            Begin
                Begin TextBox
                    ...
                    BorderColor =10921638
                    ForeColor =4210752
                    Name ="AccessTotalsاسم المستخدم"
                    ControlSource ="=Count(*)"
                    FontName ="Arial"
                    EventProcPrefix ="AccessTotalsاسم_المستخدم"
